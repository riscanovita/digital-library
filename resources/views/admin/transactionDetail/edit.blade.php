...
<div class="row">  
	<div class="col-md-7">     
		<div class="card card-primary">
			...
			<form method="post" action="{{ url('details/'.$transactionDetail->id) }}">
				@csrf
                @method('PUT')
				...
				<div class="card-body">                
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="qty" class="form-control @error('qty') is-invalid @enderror" name="qty" required="" value="{{ old ('qty') }}"
                            @error('qty')
						        <div class="invalid-feedback">{{ $message }}</div>
						    @enderror 
                        </div>
